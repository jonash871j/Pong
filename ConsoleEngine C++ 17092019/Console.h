...
namespace Console
{
	...
	void WriteChar(int x, int y, char character, char color);

	// Used to write a string to the console
	void WriteString(int x, int y, std::string text, char direction, char color);

	// Used to write a int to the console
	void WriteInt(int x, int y, int intValue, char direction, char color);
	...
	void SetColorRGB(char id, char red, char green, char blue);
